...
L["Sturdy Chest 4 Note"] = "Он на выступе над комнатой. Есть точка захвата, чтобы туда попасть."
L["Sturdy Chest 5"] = "|cFFFFFFFFПрочный сундук|r"
...
L["Sturdy Chest 9 Note"] = "Под водой - содержит игрушку Древний голем."
